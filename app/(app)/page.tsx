...
export default async function Home() {
  ...
  const [{ data: courses }, { data: statsData }, user] = await Promise.all([
      ...
      <main className="relative z-10">
        <section className="px-6 lg:px-12 pt-16 pb-24 max-w-7xl mx-auto">
          <div className="flex flex-col items-center text-center">
            ...
            >
              Join Karan&apos;s Academy and learn from expertly crafted courses,
            ...
            {[
              {
                ...
                content:
                  "Karan's teaching style is incredible. I went from knowing nothing to landing my first dev job in 6 months!",
                avatar: "🧑‍💻",
              },
              {
                name: "Sarah Miller",
        ...
        <footer className="px-6 lg:px-12 py-12 border-t border-zinc-800/50 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold">Karan&apos;s Academy</span>
            </div>
            ...
            <p className="text-sm text-zinc-600">
              © 2026 Karan&apos;s Academy. All rights reserved.
            </p>
          </div>
        </footer>
      </main>

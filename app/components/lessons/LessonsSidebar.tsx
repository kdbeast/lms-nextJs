          ...
          >
            {modules.map((module, moduleIndex) => {
              ...
              return (
                ...
                >
                  <AccordionTrigger className="px-4 py-3 hover:no-underline hover:bg-zinc-800/50 text-left cursor-pointer">
                          ...
                          <Link
                            ...
                            className={cn(
                              ...
                              isActive
                                ...
                                : "text-gray-200 hover:text-gray-100 hover:bg-zinc-600",
                            )}
                          >
                            {isCompleted ? (

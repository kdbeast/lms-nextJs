...
type DocumentActionsProps = DocumentHandle
    ...
    <div className="flex items-center gap-2">
      ...
      {isDraft && hasPublishedVersion && (
        <button
          ...
          className="cursor-pointer inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-zinc-400 border border-zinc-700 rounded-lg hover:bg-zinc-800 hover:border-zinc-600 hover:text-zinc-300 transition-colors"
        >
      ...
      {!isDraft && (
        <button
          ...
          className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-zinc-400 border border-zinc-700 rounded-lg hover:bg-zinc-800 hover:border-zinc-600 hover:text-zinc-300 transition-colors cursor-pointer"
        >
      ...
      {isDraft && (
        <button
          ...
          className="cursor-pointer inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-white bg-linear-to-r from-violet-600 to-fuchsia-600 hover:from-violet-500 hover:to-fuchsia-500 rounded-lg shadow-lg shadow-violet-500/20 transition-all"
        >
      ...
      <button
        ...
        className="cursor-pointer h-8 w-8 inline-flex items-center justify-center text-zinc-500 hover:text-red-400 hover:bg-red-500/10 rounded-lg transition-colors"
        title="Delete"
      >
